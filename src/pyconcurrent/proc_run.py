...
class ProcRun:
    ...
    def __init__(self,
        ...
        :param pargs: The first element is the command/function to be run and remainder
                  are any additional arguments.

        :param tasks_todo: list of task items to be run concurrently.
        ...
        :param num_workers: Max number of processes to use. Value of 0 is unlimited and 1 will
                             mean each is run serially one at a time.

        :param timeout: The maximum number of seconds allotted to each process.
        ...
        :param verb: If set to true, some additional information is sent to stdout.

        :attributes result: list of ProcResult results, one per task. See ProcResult for more detail.
        """
        self.ok: bool = True
        self.verb: bool = verb
